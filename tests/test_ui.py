...
def test_reading_accent_thresholds() -> None:
    ...
    assert reading_accent(warn, 85.0) == "#fbbf24"
    assert reading_accent(hot, 85.0) == "#f97316"
...
def test_summary_pickers() -> None:
    ...
    fan = _reading(category="Fan", name="Processor Fan", unit="RPM", value=2400.0, group="Dell Smm")
