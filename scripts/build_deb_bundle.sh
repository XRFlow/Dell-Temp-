...
python3 -m PyInstaller --noconfirm --clean \
  ...
  "$ROOT_DIR/packaging/delltemp.spec"
...
Recommends: lm-sensors, nvidia-smi, libxcb-cursor0
Maintainer: XRFlow <support@xrflows.com>
Description: Self-contained desktop monitor for CPU/GPU temperatures and fans
